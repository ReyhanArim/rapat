								...
								<tr>
                                    ...
                                    <td class="text-center">
                                        <form onsubmit="return confirm('Apakah Anda Yakin ?');" method="POST">
                                            ...
                                            <?php echo csrf_field(); ?>
                                            <a href="/pegawai/hapus/<?php echo e($p->IDpegawai); ?>" class="btn btn-sm btn-danger">Hapus</a>
                                        </form>
                                    </td>
                                </tr>
...
</html><?php /**PATH C:\xampp\htdocs\Kuliah\Workshop\Projek Akhir\rapat\resources\views/Rapat/Pegawai/index.blade.php ENDPATH**/ ?>