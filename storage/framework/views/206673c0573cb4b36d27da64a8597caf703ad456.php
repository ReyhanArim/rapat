            ...
            <div class="col-md-12">
                <div class="card border-0 shadow rounded">
                    <div class="card-body">
                        ...
                        <a href="peserta/input" class="btn btn-md btn-success mb-3">TAMBAH POST</a>
								...
								<tr>
                                    ...
                                    <td class="text-center">
                                        <form onsubmit="return confirm('Apakah Anda Yakin ?');" method="POST">
                                            <a href="/peserta/edit/<?php echo e($p->IDpeserta); ?>" class="btn btn-sm btn-primary">EDIT</a>
                                            <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\xampp\htdocs\Kuliah\Workshop\Projek Akhir\rapat\resources\views/Rapat/Peserta/peserta.blade.php ENDPATH**/ ?>